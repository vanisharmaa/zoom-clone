...
const MeetingRoom = () => {
  ...
  const isPersonalRoom = !!searchParams.get("personal"); // !! gives boolean value out of other data types
  ...
  return (
    <section className="relative h-screen w-full  pt-4 text-white">
      <div className="fixed bottom-7 flex size-full items-center justify-center">
